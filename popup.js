/* Popup UI: pick/drag a resume, convert in-browser, download the ATS DOCX. */
...
(function () {
  ...
  // Point pdf.js at the locally bundled worker (required by MV3 / CSP).
  if (typeof pdfjsLib !== "undefined" && chrome.runtime) {
  ...
  convertBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      if (apiKey && warned) {
        setStatus("Downloaded " + filename + " (offline \u2014 AI unavailable).", "ok");
      } else {
